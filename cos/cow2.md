# ChemOffice 19.0 / 18.2 完美激活方法: 一键轻松解决
...
<p align="center">
<img width="80%" height="80%" src="/cos/190.jpg">
</br>图1 给环着色（图片仅作范例，不代表个人审美）
<img width="80%" height="80%" src="/cos/191.png">
</br>图2 支持指定聚合度、Unicode、结构式检索插件
</p>

## 为什么使用本方法
* 网传破解方法需要手动复制替换文件
* 网传破解方法未提供破解64位程序，从64位 Office中无法打开内嵌对象
...
* 自19.0版本起，[之前推送](/cos/cow.md#激活方法)中提到的激活方法失效，详见[破解原理](/cos/cow3.md)

## 懒人安装破解
* 直接下载运行单文件版安装破解程序，即可正常使用 **ChemOffice 19.0（文件名：`cos19.0_Crack.exe`）** 或18.2版（文件名：`cos18.2_Crack.exe`）
...
* 双击运行后，显示图3所示提示，解压完毕后自动运行安装程序，首先跳出图4所示激活窗口，点击`Activate`，然后正常安装完成即可使用
<p align="center">
...
* 最后会弹出图4所示激活窗口，点击`Activate`，然后即可使用软件了
...
<p align="center"><img width="80%" height="80%" src="/cos/195.png"></p>